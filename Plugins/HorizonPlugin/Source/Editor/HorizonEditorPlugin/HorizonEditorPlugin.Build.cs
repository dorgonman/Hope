...
{
	public class HorizonEditorPlugin : ModuleRules
	{
		public HorizonEditorPlugin (TargetInfo Target)
		{
            ...
            PublicIncludePaths.AddRange(new string[] { "HorizonEditorPlugin/Public" });
            PrivateIncludePaths.AddRange(new string[] { "HorizonEditorPlugin/Private" });
